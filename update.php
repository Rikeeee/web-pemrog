...
<body>
  ...
  <section class="row">
    <div class="col-md-6 offset-md-3 align-self-center"> 
      ...
      <form method="POST">
        ...
        <div class="mb-3">
          <label for="inputNis" class="form-label">NRP</label>
          <input type="number" class="form-control" id="inputNis" value="<?= $data['NRP'] ?>" name="NRP" placeholder="Masukan NRP Siswa">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="inputKelas" value="<?= $data['Prodi'] ?>" name="Prodi" placeholder="Masukan Kelas Siswa">
        </div>
  ...
  <?php
    ...
    if(isset($_POST['daftar'])){
      ...
      // Membuat Query
      $query = "UPDATE tb_siswa SET NRP = '$NRP', Nama = '$Nama', Prodi = '$Prodi' WHERE id = '$id'";
